<h2><a href="https://www.geeksforgeeks.org/problems/find-kth-permutation-0932/1?itm_source=geeksforgeeks&itm_medium=article&itm_campaign=practice_card">Find Kth permutation</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given two integers&nbsp;<strong>N&nbsp;</strong>(1&lt;=N&lt;=9) and&nbsp;<strong>K</strong>. Find the kth permutation sequence of first N natural numbers. Return the answer in&nbsp;<strong>string</strong>&nbsp;format.</span></p>
